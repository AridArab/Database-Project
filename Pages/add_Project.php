...
$params = array($_POST['progress'], $_POST['projectName'], $_POST['cost'], $_POST['address'], $_POST['city'], $_POST['state'], $_POST['zip'], $_POST['deptID'], $_POST['budget'], 1, $_POST['startdate'], NULL, $_POST['deadline']);
